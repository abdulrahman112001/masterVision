...
import AddCharType from "./AddCharAccount";
import AddCharAccount from "./AddCharAccount";

function MainChartAccount() {
  ...
  const endpoint = `accounting/chartaccount?${searchParams.toString()}`;
...
export default MainChartAccount;
