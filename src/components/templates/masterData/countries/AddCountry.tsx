...
import CountriesFormMainData from "./CountriesFormMainData";
import {
  AllCountriesTable_TP,
  initialValue_Tp,
  validationSchema,
...
function AddCountry({ refetch, update }: AddCountry_TP) {
  ...
  const handleSubmit = (values: AllCountriesTable_TP) => {
    const finalOutput = {
